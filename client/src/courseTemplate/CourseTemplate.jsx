...
import {
  FaClock, FaRupeeSign, FaFileDownload, FaProjectDiagram, FaCheckCircle, FaGraduationCap
} from 'react-icons/fa';
import { useNavigate, useLocation } from 'react-router-dom';
import { fixedCourses } from "../data/courseTemplate.js";
  ...
  return (
    <main className="container py-5 course-template">
      ...
      <div className="row align-items-center">
        ...
        <div className="col-md-7 mb-5 d-flex align-items-start justify-content-center flex-column">
            ...
            <p>
              {
                courseData.fees === ""
                  ? "Course Expired"
                  : `₹${courseData.fees || "7000"} (GST not included)`
              }
            </p>
          </p>
          ...
          {courseData.pdfLink ? (
            <div className="d-flex gap-3 flex-wrap mb-3">
              <button
                onClick={() => window.open(courseData.pdfLink, '_blank')}
...
>>>>>>> e519c8f7158a9a2b01943f51cbfff4688628a1e9
            </div>
          ) : (
