...
function Footer() {
  ...
  return (
    <footer className="bg-dark text-light pt-5 pb-3 mt-2" >
      ...
      {/* Bottom Footer */}
      <div className="bg-black text-white-50 py-2 px-3 d-flex align-items-center w-100 bg-warning">
        <div className="text-center w-100">&copy; 2025 NTI Academy, All Rights Reserved</div>
        <div>
