...
function Footer() {
  ...
  return (
    <footer className="bg-dark text-light pt-5 pb-3 mt-2" >
      ...
      {/* Bottom Footer */}
      <div className="text-white-50 p-2 w-100 position-relative bg-black d-flex align-items-center">
        <div className="text-center w-100">
          &copy; 2025 NTI Academy, All Rights Reserved
        </div>
        <button className="position-absolute top-0 end-0 me-2 mt-1 border border-2 p-2 text-white bg-dark rounded-2"
        ><FaArrowUp /></button>
      </div>
    </footer >
  );
