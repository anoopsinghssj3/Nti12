  ...
  return (
    <footer className="bg-dark text-light pt-5 pb-3 mt-2" >
      ...
      <div className=" text-white-50 py-2 px-3 w-100 bg-warning">
        <div className="text-center w-100">&copy; 2025 NTI Academy, All Rights Reserved  <FaArrowUp className="border border-2 p-2 text-white  position-relative top-0 translate-middle" fontSize="2rem"/>
        </div>
      </div>
    </footer >
  );
