      ...
      <nav className="navbar navbar-expand-lg navbar-light bg-light text-secondary main-navbar">
        <div className="container-fluid">
          ...
          <div className="collapse navbar-collapse " id="navbarSupportedContent">
            <ul className="navbar-nav  gap-2 mb-2 mb-lg-0 d-flex align-items-start bg-warning">

              <Link className="nav-link nav-item active home-style text-secondary system bg-danger " to="/">
                <IoMdHome fontSize="1.5rem" className='mb-1' /> Home
              </Link>

              <Link className="nav-item dropdown system bg-danger" data-bs-toggle="dropdown" role="button">
                {/* <span className="nav-link dropdown-toggle text-secondary bg-danger" > */}
              ...
              <Link className="nav-link text-secondary system bg-danger" to="/placement">
                <GiSuitcase fontSize="1.5rem" className='mb-1' /> Placement
              </Link>

              <Link className="nav-link text-secondary system bg-danger" to="/corpo_tra">
                <IoSchoolSharp fontSize="1.25rem" className='mb-1' /> Corporate Training
              </Link>

              <Link className="nav-link text-secondary system bg-danger" to="/on_tra">
                <FaFileSignature fontSize="1.25rem" className='mb-1' /> Online Registration
              </Link>

              <Link className="nav-link text-secondary system bg-danger" to="/certificate">
                <PiCertificateFill fontSize="1.5rem" className='mb-1' /> Certificate
              </Link>

              <Link className="nav-link dropdown nav-item text-secondary system bg-danger" to="/about ">
