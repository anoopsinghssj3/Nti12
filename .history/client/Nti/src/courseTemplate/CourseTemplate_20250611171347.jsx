...
const CourseTemplate = () => {
  ...
  const imageList = useMemo(() => [
    "https://camo.githubusercontent.com/5119ee303e5e49cdf23def653b737bede0da49a859a34714d62d9ab518afbbb2/6874747073...",
    "https://camo.githubusercontent.com/5046cb083418fd1922b7f5990e594c3bb06f5d87e5516cd8839ae0aa48b3aec4/6874747073...",
    "https://camo.githubusercontent.com/2366b34bb903c09617990fb5fff4622f3e941349e846ddb7e73df872a9d21233/6874747073...",
    "https://camo.githubusercontent.com/4d9f5ecceb711eec6e2018f38a5677dc657c9738d4a65ba3b928c41c0a45b439/6874747073...",
    "https://camo.githubusercontent.com/130ffc354b6ee3c8c9e506276e598bf4e19ea7950df203dacf6aeee4fc543a50/6874747073...",
    "https://camo.githubusercontent.com/88adc7c88c9d3dba7479020846ed35d13410e3707c7f149e1c6140cc6beaef9a/6874747073...",
    "https://camo.githubusercontent.com/87af9a9fec730c94fc8b08eb21fa5ef6ab7831a67ba17bf8cc76696f6e4be1ef/6874747073...",
    ...
    "https://cdn.dribbble.com/userupload/21606445/file/original-87f89c32747bd361f530e0735083d18d.gif",
    "https://miro.medium.com/v2/resize:fit:1400/1*IO0G2ygwIml_NGAv26Na4w.gif",
    "https://static1.squarespace.com/static/558c162ee4b03447dc049b73/t/56a09aef9cadb60afe120881/1453366010166/?format=1500w",
  ...
  const [randomImage, randomImage2] = useMemo(() => {
    let first = Math.floor(Math.random() * imageList.length);
    let second;
    do {
      second = Math.floor(Math.random() * imageList.length);
    } while (second === first);
    return [imageList[first], imageList[second]];
  }, [imageList]);
  ...
  useEffect(() => {
    ...
    if (normalizedFixedCourses[normalizedCourse]) {
      ...
      setImg(courseData.img || DEFAULT_IMG);
      setLoading(false);
    } else {
      ...
      axios.get(`https://en.wikipedia.org/api/rest_v1/page/summary/${encodeURIComponent(query)}`)
        .then((res) => {
          setDescription(res.data.extract || "No description available for this course.");
          setImg(DEFAULT_IMG);
        })
        .catch(() => {
  ...
  return (
    <main className="container py-5 course-template">
      ...
      <div className="row align-items-center">
        {/* Left side - images */}
        <div className="col-md-5 text-center mb-4 mb-md-0 d-flex flex-column align-items-center gap-3">
          <img
        ...
        <div className="col-md-7">
          ...
          <ul>
            {(courseData.extras || ["Placement Support", "Resume & Interview Preparation"]).map((extra, idx) => (
              <li key={idx}>{extra}</li>
            ))}
          </ul>
